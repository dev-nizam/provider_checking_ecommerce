                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            Text("Discription",style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),),
                            Container(
                              height:180 ,
                              child: Text("Even if you weren't around for the iconic origins of adidas tennis footwear, you can still appreciate the style. Bring some big vintage vibes to your daily wardrobe with these adidas shoes. A synthetic leather upper is durable with a premium fit and feel. The slab rubber outsole and 3-Stripes in retro colour combinations complete the throwback look."),
                            )
